...
# Heading
title = tk.Label(root, text="🎨 Color Blindness Test", font=("Arial", 22, "bold"), bg="white")
title.pack(pady=10)
...
def check_answer(selected_color):
    ...
    if selected_color == correct_color:
        ...
        feedback.config(text=f"❌ Wrong! It was {correct_color}.", fg="red")
...
# Next button
next_btn = tk.Button(root, text="Next ▶", font=("Arial", 12, "bold"), command=generate_color, bg="#0078D7", fg="white")
